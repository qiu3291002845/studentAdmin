<template>
    <div>
        <el-button class="mb-4" type="primary" @click="createStudent">新建学生</el-button>
        ...
        <el-pagination :total="totalInfo" :page-size="pageSize" @size-change="handleSizeChange" @current-change="currentChange" :current-page="count" class="mt-4" background layout="sizes,prev, pager, next" :page-sizes="[1, 2, 3, 4]"></el-pagination>
    </div>
</template>
<script>
export default {
